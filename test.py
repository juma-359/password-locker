...
class TestUser(unittest.TestCase):
    ...
    def set_Up(self):
        ...
        '''
        self.new_credentials = credentials("twitter","billowbashir","abcdefg")
    def tear_Down(self):
        '''
        method that does clean up after each test case has run.
        '''
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.password,"abcdefg")
    ...
    def test_save_multiple_credentials(self):
        ...
        '''
        self.new_credentials.save_credentials()
        test_credentials = credentials("test","testname","123456789")
